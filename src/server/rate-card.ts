...
export const defaultRateCardPeople: SeedRateCardPerson[] = [
  ...
  {
    seedIdentifier: "gitwork.usman-ali",
    name: "Usman Ali",
    area: "Senior • Frontend, Backend, AI, DevOps",
    sourceRate: 1900,
    sourceCurrencyCode: "USD",
  ...
  {
    seedIdentifier: "gitwork.zain-ali",
    name: "Zain Ali",
    area: "Mid Level • Flutter, Frontend, Backend, AI, DevOps",
    sourceRate: 1500,
    sourceCurrencyCode: "USD",
    billingPeriod: "MONTH",
  },
  ...
  {
    seedIdentifier: "gitwork.aashir-awan",
    name: "Aashir Awan",
    area: "Senior • Flutter, Frontend, Backend, DevOps",
    sourceRate: 1900,
    sourceCurrencyCode: "USD",
    billingPeriod: "MONTH",
  },
  {
    seedIdentifier: "gitwork.sibghatullah",
    name: "Sibghatullah",
    area: "Mid Level • Frontend, Backend, DevOps",
    sourceRate: 1500,
    sourceCurrencyCode: "USD",
    billingPeriod: "MONTH",
  },
  {
    seedIdentifier: "gitwork.m-shoaib",
    name: "M Shoaib",
    area: "Mid Level • Frontend, Backend, AI",
    sourceRate: 1500,
    sourceCurrencyCode: "USD",
  ...
  {
    seedIdentifier: "gitwork.m-tayyab",
    name: "M Tayyab",
    area: "Mid Level • Frontend, Backend",
    sourceRate: 1500,
    sourceCurrencyCode: "USD",
