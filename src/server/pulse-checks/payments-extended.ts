...
export async function runPaymentsExtended(ctx: ExtendedCheckContext): Promise<PulseScanCheckInput[]> {
  ...
  if (!pctx.isPaymentEnabled) {
    return [
      ...
      category: "Payments", checkKey, label: checkKey.replace(/_/g, " "),
