  ...
  return (
    <div>
      ...
      <div className="mb-5 flex items-start justify-between gap-4">
        <div>
          <h2 className="text-[22px] font-semibold tracking-[-0.01em] text-[var(--text-1)]">Changelog</h2>
          <p className="mt-0.5 text-[13px] text-[var(--text-4)]">Version history across platforms</p>
        </div>
        {!readOnly && (
          <button
            type="button"
