...
export function FeatureBlockFormModal({
  ...
  async function handleSave() {
    ...
    // Dates are optional — a block becomes a Gantt bar only once both are set.
      ...
      <div className="app-dialog-panel relative z-10 flex max-h-full w-full max-w-lg flex-col">
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-6 py-5">
          ...
          <p className="-mt-2 text-[11px] text-[var(--text-4)]">
            Leave dates blank to keep this as a board-only list — add both to place it on the Gantt.
          </p>
          <div>
