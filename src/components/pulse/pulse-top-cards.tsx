...
/**
 * The three top Pulse cards (Portfolio · Research studies · Starters) as one uniform,
 * collapse-in-unison row. Collapsed by default on first load to save room; the chevron in any
 * card header toggles all three together (kept in sync + persisted so the row stays uniform in
 * both states — no ragged mixed heights).
 */
