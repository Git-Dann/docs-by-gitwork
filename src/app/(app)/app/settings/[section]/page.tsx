...
// "connected-apps" is the per-user MCP panel — Admin+ for now (structurally), can later be
// permission-driven via mcp.connect if STAFF/DEVELOPER should self-connect.
